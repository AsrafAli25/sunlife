...
const SeventhPolicy = () => {
  const { valueOne, valueTwo, valueThree, valueFour, valueFive, valueSix } =
    ...
    <div className="card m-8">
      <Card title="Total estimated monthly premium before applicable taxes:">
        ...
        <div>
          ...
          <h4 className="my-3">EXTENDED HEALTHCARE INSURANCE ${valueFour}</h4>
          <h4 className="my-3">CRITICAL ILLNESS INSURANCE ${valueFive}</h4>
          <h4 className="my-3">LONG-TERM DISABILITY INSURANCE ${valueSix}</h4>
